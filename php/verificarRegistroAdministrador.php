...
$objetoRegistroAdministrador = new Seleccion;
...
if(isset($_POST['usuario']) AND isset($_POST['contrasena']) AND isset($_POST['nombre']) AND isset($_POST['ap']) AND isset($_POST['am']) AND isset($_POST['telf']) AND isset($_POST['email']) AND isset($_POST['gen'])
	...
	*/
	...
	$consulta = $objetoRegistroAdministrador->registroUsuario($usuario,$contrasena,$nombre,$apaterno,$amaterno,$email,$telefono, $sexo, $edad, $puesto ,$colonia, $direccion);
	
	if(mysql_num_rows($consulta)>0){
		header('location: ../html/logeado.html');
	} else {
		 $objetoRegistroAdministrador->regUsuario($usuario,$contrasena,$nombre,$apaterno,$amaterno,$email,$telefono, $sexo, $edad, $puesto ,$colonia, $direccion);
